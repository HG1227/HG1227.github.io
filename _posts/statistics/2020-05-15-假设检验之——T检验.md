...
1. 对于**要检验样本均值是否等于总体均值的双侧检验**，若根据样本数据算出来的![[公式]](https://www.zhihu.com/equation?tex=t)统计量的绝对值 <img src=".\img\student t\equation (7).svg" alt="equation (7)"  />，则拒绝原假设，认为样本均值与总体均值不等，否则不拒绝原假设。
2. 对于**要检验样本均值是否比总体均值大的单侧检验**，若根据样本数据算出来的![[公式]](https://www.zhihu.com/equation?tex=t)统计量 <img src=".\img\student t\equation (8).svg" alt="equation (8)"  />，则拒绝原假设，认为样本均值不大于总体均值，否则不拒绝原假设。
3. 对于**要检验样本均值是否比总体均值小的单侧检验**，若根据样本数据算出来的![[公式]](https://www.zhihu.com/equation?tex=t)统计量<img src=".\img\student t\equation (9).svg" alt="equation (9)"  /> ，则拒绝原假设，认为样本均值不小于总体均值，否则不拒绝原假设。
...
<center><img src=".\img\student t\equation (10).svg" alt="equation (10)"  /></center>

<center><img src=".\img\student t\equation (11).svg" alt="equation (11)"  /></center>
...
既然是配对设计，不妨设 $$n=n_{1}=n_{2}$$；方差相等，有 $$\sigma^{2}=\sigma_{1}^{2}=\sigma_{2}^{2}$$。取要检验的指标的差值 $$d_{i}=X_{1 i}-X_{2 i}$$，计算 $d_i$ 的样本标准差<img src=".\img\student t\equation (15).svg" alt="equation (15)"  /> 。要检验配对样本均数的差是否为0，即检验 $d_i$ 的均值是否为0，这样就转化为了“1.单样本t检验”，
...
<img src="F:.\img\student t\equation (16).svg" alt="equation (16)" style="zoom:150%;" />

写为矩阵形式：

<img src=".\img\student t\equation (17).svg" alt="equation (17)"  />

其中：

<img src=".\img\student t\equation (18).svg" alt="equation (18)"  />

<img src=".\img\student t\equation (19).svg" alt="equation (19)"  />
...
\end{equation}
$$
其中<img src=".\img\student t\equation (24).svg" alt="equation (24)"  /> ![[公式]](https://www.zhihu.com/equation?tex=%5Csigma%5E2)的无偏估计（证明见**附录2.2**）。

根据![[公式]](https://www.zhihu.com/equation?tex=t) 分布的构造定义，由 <img src=".\img\student t\equation (25).svg" alt="equation (25)"  /> 得：

<img src=".\img\student t\equation (26).svg" alt="equation (26)"  />
