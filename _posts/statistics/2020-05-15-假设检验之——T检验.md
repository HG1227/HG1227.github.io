...
$$
构造出一个![[公式]](https://www.zhihu.com/equation?tex=t)统计量，我们知道![[公式]](https://www.zhihu.com/equation?tex=t)变量的构造定义是一个 分子为标准正态变量、分母为卡方变量除以它自由度后开根号 的分式。上面我们已经得到了一个标准正态变量，不难想到卡方变量的一个重要定理：
